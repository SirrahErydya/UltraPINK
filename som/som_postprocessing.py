...
class SOM(object):
    ...
    """
    def __init__(self,  dataset_name, som_path, mapping_path, som_obj_path,
                 som_label='- 15x15'):
        ...
        # Mapping indices for prototypes sorted by distance
        self.sorted_proto_idxs = np.argsort(self.data_map, axis=1)
        self.number_of_images = no_imgs

        self.som_obj_path = som_obj_path
    ...
    def save(self):
        with open(self.som_obj_path, 'wb') as file:
